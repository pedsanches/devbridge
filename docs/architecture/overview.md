...
| **Claude 3.5 Sonnet** | LLM para tradução e raciocínio |
...
| Componente | Responsabilidade |
|------------|------------------|
| **PostgreSQL** | Metadados relacionais (repos, commits, usuários) |
...
| Componente | Responsabilidade |
|------------|------------------|
| **Next.js Dashboard** | Interface de chat e visualização |
