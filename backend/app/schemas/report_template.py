...
DEFAULT_SECTIONS: list[SectionConfig] = [
    SectionConfig(type=SectionType.SUMMARY, title="Resumo Executivo", order=0, enabled=True),
    SectionConfig(type=SectionType.METRICS, title="Métricas e KPIs", order=1, enabled=True),
    SectionConfig(type=SectionType.HIGHLIGHTS, title="Destaques", order=2, enabled=True),
    SectionConfig(type=SectionType.RISKS, title="Riscos e Atenções", order=3, enabled=True),
    SectionConfig(type=SectionType.TECHNICAL, title="Detalhes Técnicos", order=4, enabled=False),
    SectionConfig(type=SectionType.TIMELINE, title="Linha do Tempo", order=5, enabled=False),
    SectionConfig(type=SectionType.CONTRIBUTORS, title="Contribuidores", order=6, enabled=False),
]
